...
class MyFireworksFrame extends WxAdaptiveFrame {
  MyFireworksFrame( WxFrame? parent) : super( parent, -1, "Fireworks!", size: WxSize(900, 700) ) 
  {
    ...
    // Touch interface
      ...
      appBar.addAction( idAbout, "Start Fireworks!" );
      // add action with text button
      appBar.addAction( wxID_EXIT, "Quit" );

      final button = createFloatingActionButton("Fire!", idAbout, WxBitmapBundle.fromMaterialIcon( WxMaterialIcon.fireplace, WxSize(32, 32)) );
    ...
    bindMenuEvent((_) => startFirework(), idAbout );
    bindButtonEvent((_) => startFirework(), idAbout );
